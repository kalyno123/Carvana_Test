...
public class Waiters {
    ...
    public static void waitForVisibilityOfElement(WebDriver driver, List<WebElement> element, int seconds){
        new WebDriverWait(driver, seconds).until(ExpectedConditions.visibilityOf((WebElement) element));
    }
